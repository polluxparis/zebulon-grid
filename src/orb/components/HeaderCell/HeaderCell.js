...
export default class HeaderCell extends Component {
  ...
  //   if (nextProps.cell && nextProps.cell === this.props.cell
  //      && !this._latestVisibleState && !nextProps.cell.visible()) {
  //     return false
  //   }
  //   return true
  // }
  render() {
    ...
    switch (cell.template) {
      ...
      case 'cell-template-column-header':
        // const isWrapper = cell.type === HeaderType.WRAPPER
        // && cell.dim.field.subTotal.visible && cell.dim.field.subTotal.collapsible
