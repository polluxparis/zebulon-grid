...
exports.twoArraysIntersect = twoArraysIntersect;
...
function arraysIntersect() {
  ...
  for (var _i = 0; _i <= nOthers; _i++) {
    n = _i === shortest ? 0 : _i || shortest; // Read the shortest array first. Read the first array instead of the shortest
